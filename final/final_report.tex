...
DNA makes RNA makes proteins. Technically speaking, two processes, transcription (DNA to RNA) and
translation (RNA to protein) play a key part of synthesising a functional product of a gene (e.g. protein).
...
It is believed that the physical structure of DNA plays an important part in gene regulation. 
Tightly packed regions of DNA are harder to interact with, therefore harder for transcription factors or RNA polymerase to bind with the DNA. Modifications of the core histones, can change the structure of chromatin and therefore change the accessibility of DNA for processes such as transcription.
For instance, acetylation of histone H4 on lysine 16 (shortened as \histonemodification{H4K16Ac}) has been shown to inhibit formation of the 30-nanometer fiber (pictured in panel 5 of \autoref{fig:background:dna_packaging}) \cite{ShogrenKnaak:2006gt}. Other histone modifications, such as Histone 3 lysine 4 trimethylation (\histonemodification{H3K4Me3}) tend to locate near transcription start sites and correlate with the transcriptional activity of genes\cite{Pokholok:2005wn}.

The development of next-generation sequencing techniques has allowed ... \todo{here}
