...
def visualise_dtw_mappings(index_a, index_b, *args, **kwargs):
    if isinstance(index_a, basestring):
        a = data.ix[index_a]
        b = data.ix[index_b]
        x_label = index_a
        y_label = index_b
    ...
    return dgw.dtw.visualisation.visualise_dtw_mappings(a,b, sequence_x_label=x_label, sequence_y_label=y_label, dtw_function=dtw_func)
