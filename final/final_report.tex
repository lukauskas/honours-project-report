...
Finally, the implementation of DTW algorithm used in the software is based on \pythonpackage{mlpy} package\cite{Albanese:2012vf}. The author of this project has written the code allowing this package to support variations of DTW algorithm, such as Sakoe \& Chiba band as described in \autoref{sec:DTW}. As well as added support for the alignment of multidimensional data as well.
